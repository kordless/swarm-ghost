...
sed -e "s,%DOMAIN%,$DOMAIN,g;" -i config.js
sed -e "s,%MYSQL_SERVER%,$MYSQL_PORT_3306_TCP_ADDR,g;" -i config.js
sed -e "s,%MYSQL_USERNAME%,$MYSQL_USERNAME,g;" -i config.js
sed -e "s,%MYSQL_PASSWORD%,$MYSQL_PASSWORD,g;" -i config.js
